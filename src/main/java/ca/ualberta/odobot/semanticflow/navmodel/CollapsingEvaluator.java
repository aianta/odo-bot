        ...
        public boolean matches(Path path){
            ...
            while (patternIterator.hasNext()){
                ...
                if(!patternNode.label.equals(pathNode.label) || //If the labels do not match, then this is not a match.
                        (patternNode.label.equals("GraphQLNode") && pathNode.label.equals("GraphQLNode") && !patternNode.elementId.equals(pathNode.elementId)) || //If the nodes have matching GraphQLNode labels, they must be an ending anchor (that is, the same elementId), otherwise no match.
