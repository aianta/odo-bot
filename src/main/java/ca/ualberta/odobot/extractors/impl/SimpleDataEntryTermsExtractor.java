...
public class SimpleDataEntryTermsExtractor implements SemanticArtifactExtractor<DataEntry> {
    @Override
    ...
    public Object extract(DataEntry entity) {
        ...
        return rankingStrategy.getTerms(entity.lastChange(), strategy, DistanceToTarget.SourceFunction.TEXT.getFunction())
