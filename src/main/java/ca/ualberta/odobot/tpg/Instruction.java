...
public class Instruction extends BitSet
{
    ...
    public static final Instruction COND = new Instruction( 0x4 );
    public static final Instruction WRIT = new Instruction( 0x5 );
    ...
    public static final int WRIT_VALUE = 5;

    public static final int OPERATION_COUNT = 6;
