...
/**
 * A more in-depth approach to normalizing URL, shamelessly taken from:
...
public class NormalizeURL
{
     ...
     */
    public static SortedMap<String, String> createParameterMap(final String queryString)
    {
     ...
     */
    public static String canonicalize(final SortedMap<String, String> sortedParamMap)
    {
